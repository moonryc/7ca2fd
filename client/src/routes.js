  ...
  return (
    <SocketContext.Provider value={socket}>
      ...
      <Switch>
        <Route
          path="/login"
          render={() => <LoginSignup isLogin={true} user={user} login={login} />}
        />
        <Route
          path="/register"
          render={() => <LoginSignup isLogin={false} user={user} register={register} />}
        />
        <Route
          exact
          path="/"
          render={(props) =>
            user?.id ? (
              ...
              <LoginSignup isLogin={false} user={user} register={register} />
            )
          }
        />
        <Route
